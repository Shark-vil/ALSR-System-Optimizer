...
timer.Simple( 5, function()
    ...
    if ( not file.Exists("cache_alsr_help.txt", "DATA") ) then
        ...
        local ru_lang = {
            ['title'] = "Разработка Anti Lag System Redux остановлена!",
            ['html_button'] = "Перейти по ссылке",
            ['html_button_back'] = "Вернуться на главную",
            ['link'] = "https://itpony.ru/alsr/ru.html"
        };

        local en_lang = {
            ['title'] = "Development of Anti Lag System Redux is stopped!",
            ['html_button'] = "Go to the link",
            ['html_button_back'] = "Go back to the main",
            ['link'] = "https://itpony.ru/alsr/en.html"
        };
        ...
        file.Write( "cache_alsr_help.txt", "" );
